...
{
    case 'bar':
        cms::get_cms('2', '4', false, true, 'ASC', 'Bar');
    break;
    
    case 'beer':
        cms::get_cms('7', '4', true, true, 'ASC', 'Beer');
    break;

    case 'foo':
    default:
        cms::get_cms('2', '4', true, true, 'ASC', 'Foo');
    break;
}

// Output page
page_header($page);
// custom CSS and JS path
site_style('css', 'js');
//set a custom template path
$template->site_template_path('templates');
